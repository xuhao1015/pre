        ...
        for (int i = 0; i < 2; i++) {
            ...
            RequestBody body = RequestBody.create(mediaType,
                    String.format("{\"mch_id\": \"1\",\"subject\": \"支付1000元\",\"body\": \"支付1000元\",\"out_trade_no\": " +
                                    "\"%s\",\"amount\": \"%s.00\",\"notify_url\": \"http://103.235.174.139/pre/jd/callbackTemp\",\"return_url\": \"http://1111.com/success.html\",\"timestamp\": \"2014-07-24 03:07:50\",\"sign\": \"c815c971fdabbda20f8fdf7d0ee658ff\",\"client_ip\":\"192.168.2.1\",\"pass_code\":\"8\"}",
                            PreUtils.getRandomString(15), (i + 1) * 100 + ""));
            Request request = new Request.Builder()
                    .url("http://103.235.174.139/api/px/createOrder")
                    .post(body)
            ...
            //http://103.235.174.139/api/px/pay?orderId=202210051149015264&sign=16764b9b9f7d904a14ea8037a3b92a60
            UrlEntity urlEntity = PreUtils.parseUrl(pay_url);
            HttpRequest.get(String.format("http://103.235.174.139/api/px/pay?orderId=%s&sign=%s",
