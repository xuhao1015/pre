...
@Slf4j
//DouYNewJinritout
public class DouYNewCheckBangding {
    public static void main(String[] args) throws Exception {
        Db db = FindOrder.db;
        List<Entity> query = db.query("select * from douyin_app_ck where is_enable =1 and id > 1 and id < 8130");
