...
public class TestResoData {
  ...
  /*    String device_id = "3496879052572183";
        ...
        */
        ...
        List<Entity> appCks = db.use().query("select * from douyin_app_ck where is_enable = 0 and id >3249 ");
        List<Entity> devicesBds = db.use().query("select * from douyin_device_iid where  id > 9512  ");
