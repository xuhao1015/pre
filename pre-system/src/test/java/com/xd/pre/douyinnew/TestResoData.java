...
public class TestResoData {
  ...
  /*    String device_id = "3496879052572183";
        ...
        */
        ...
        List<Entity> appCks = db.use().query("select * from douyin_app_ck where is_enable =0 and file_name='11_5_270.txt' and id >2652 ");
        List<Entity> devicesBds = db.use().query("select * from douyin_device_iid where  id > 8246");
