...
public class SetOldAccount {
    public static void main(String[] args) throws Exception {
        List<Entity> query = FindOrder.db.query("select pt_pin ,count(1) as count from jd_order_pt   where create_time < '2022-11-28 23:00:00'  and    pay_success_time is not null   GROUP BY pt_pin");
